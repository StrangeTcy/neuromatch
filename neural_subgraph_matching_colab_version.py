...
#     print ("Setting up optimizer defaults")
...
def build_model(args):
    # build model
    print ("We're using model of type  {}".format(args["method_type"]))
    if args["method_type"] == "order":
...
def main(force_test=False):
    ...
    encoder_settings = {
                        ...
                        "eval_interval":1000,
                        "n_workers":4,
                        "model_path":"/content/drive/MyDrive/neuromatch/model.pt",
                        "checkpoint_path":"/content/drive/MyDrive/neuromatch/model.pt",
                        "tag":'',
                        "val_size":4096,
                        "node_anchored":True
                       }

    other_args = {"try_alignment":True,
                  "query_path":"",
                  "target_path":""}                   
                         
    args = {**optimiser_settings, **encoder_settings}
